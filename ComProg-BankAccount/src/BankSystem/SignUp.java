    ...
    public SignUp() {
        ...
        backBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                logInFrame.setContentPane(new LogIn().logInPanel); // Assuming logInPanel is the main panel in LogIn
                ...
                JFrame topFrame = (JFrame) SwingUtilities.getWindowAncestor(signUpPanel);
                if (topFrame != null) {
                    topFrame.dispose();
                }
            }
